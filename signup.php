                ...
                <div class="card-body">
                    <form action="authHandler.php" method="post">
                        ...
                        <div class="text-center">
                            <button class="btn btn-info" type="submit" style="margin-bottom: 20px;" name="signup">SignUp</button>
                        </div>
                        <p class="text-center" style="color: wheat;">Already a Member? <a href="login.php" style="text-decoration: none; color:white">Log In </a></p>
                    </form>
                    <?php
